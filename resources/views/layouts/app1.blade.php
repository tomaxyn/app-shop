	...
	<nav class="navbar navbar-absolute navbar-inverse">
    	<div class="container">
        	...
        	<div class="navbar-header">
        		...
        		<a class="navbar-brand" href="{{ url('/')}}"><img class="logoizi" alt="Brand" src="{{ asset('img/logo.png')}}">
                    </a>
        	</div>
        	...
        	<div class="collapse navbar-collapse" id="navigation-example">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Información de clases <span class="caret"></span></a>
                  <ul class="dropdown-menu">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <h5>Atención</h5>
                    <ul>
                        <a href="#" class="maillist"><i class="material-icons">mail</i>  Unete a nuestra lista de correo</a><br>
          <a href="{{ url ('/')}}" class="rehome"><i class="material-icons">home</i>Pagina inicial</a>
                    </ul>
                </div>
